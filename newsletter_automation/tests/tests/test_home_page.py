"""
Sanity test for the newsletter generator app.
It verifies:
    #Landing
    #Header
    #Signin link
...
def test_home_page(base_url,browser,browser_version,os_version,os_name,remote_flag,remote_project_name,remote_build_name):
    "Run the test"
    try:
...
if __name__=='__main__':
    ...
    if options_obj.check_options(options):
        test_home_page(base_url=options.url,
